...
public boolean modifyProjectDetails(Project project) {
	...
	try(Connection conn = DbConnection.getConnection()) {
		...
		try(PreparedStatement stmt = conn.prepareStatement(sql)) {
			setParameter(stmt, 1, project.getProjectName(), String.class);
			setParameter(stmt, 1, project.getEstimatedHours(), BigDecimal.class);
			setParameter(stmt, 1, project.getActualHours(), BigDecimal.class);
			setParameter(stmt, 1, project.getDifficulty(), Integer.class);
			setParameter(stmt, 1, project.getNotes(), String.class);
